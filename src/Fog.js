...
const initVertexBuffers = gl => {
    ...
    var vertices = new Float32Array([   // Vertex coordinates
        10, 10, 10,  -10, 10, 10,  -10,-10, 10,   10,-10, 10,    // v0-v1-v2-v3 front
        10, 10, 10,   10,-10, 10,   10,-10,-10,   10, 10,-10,    // v0-v3-v4-v5 right
        10, 10, 10,   10, 10,-10,  -10, 10,-10,  -10, 10, 10,    // v0-v5-v6-v1 up
       -10, 10, 10,  -10, 10,-10,  -10,-10,-10,  -10,-10, 10,    // v1-v6-v7-v2 left
       -10,-10,-10,   10,-10,-10,   10,-10, 10,  -10,-10, 10,    // v7-v4-v3-v2 down
...
const checkFace = (gl, n, x, y, currentAngle, u_PickedFace, u_ModalMatrix) => {
...
const main = (gl, canvas) => {
    ...
    projMatrix.setPerspective(30.0, 1, 1, 1000);
    
    const viewMatrix = new Matrix4();
    viewMatrix.setLookAt(25, 65, 35, 0, 2, 0, 0, 1, 0);
    ...
    //         let face = checkFace(gl, n, x_in_canvas, y_in_canvas, currentAngle, u_PickedFace, u_ModalMatrix);
    //         console.log(face);
